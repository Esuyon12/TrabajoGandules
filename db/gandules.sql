...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-06-2023 a las 22:56:07
...
(33, 'Área de Gestión de Almacenes', '2023-05-20 21:15:52', 0),
(34, 'Área de Desarrollo de Productos y Servicios', '2023-05-20 21:17:16', 0);
...
(1, 'Gandules Inc Sac', 'Jayanca, Perú.', 'GANDULES INC es una corporación fundada en el año 2002 con capitales privados y con muchos años de experiencia dedicados al manejo de tierras con fines agrícolas en los valles de Jayanca y San Pedro demostrando de esta manera un profundo compromiso con el desarrollo agroindustrial del Perú. Somos reconocidos en la actualidad tanto en el ámbito nacional como internacional como una de las empresas más importantes del sector agroindustrial del Perú, que ha sabido integrar totalmente sus operaciones productivas y la exportación de sus productos a clientes en más de 45 países dentro de 3 principales líneas de negocio: Conservas, Congelados y Frescos.  En la actualidad, GANDULES INC. SAC., es una empresa innovadora dedicada a la siembra, producción, procesamiento, empaque, envasado y comercialización de sus propios productos en una amplia variedad de presentaciones: pimientos, jalapeños, gandul, green chili, mango entre otros; empleando una población laboral que oscila entre 3,500 y 5,000 trabajadores en todas las etapas de su cadena productiva.  GANDULES INC se ha convertido en la empresa líder de su sector en la región Lambayeque y se distingue por su calidad, fiabilidad y transparencia en la gestión del negocio con el mejor servicio, el mayor compromiso e una constante innovación y mejora continua de nuestros procesos.  Nuestra moderna planta agroindustrial localizada en el valle de Jayanca ha sido edificada junto a nuestros campos de cultivo con la finalidad de garantizar que los productos recién cosechados se procesen en óptimas condiciones. Si bien el auge de la agroindustria en el Perú es relativamente nuevo, GANDULES INC. SAC., tiene ya una tradición establecida mediante una oferta de productos de la más alta calidad a los mejores precios del mercado y ésta continuará siendo la marca más distintiva de nuestra empresa.', 1, '2023-05-05 00:00:00'),
...
CREATE TABLE `tbljob` (
  ...
  `DATE_INT` timestamp NOT NULL DEFAULT current_timestamp(),
...
(6, 41, 'php', NULL),
(7, 43, 'riesgo', NULL),
(8, 43, 'prevención', NULL),
(9, 43, 'tecnico', NULL),
(10, 44, 'contable', NULL),
(11, 44, 'asistente', NULL),
(12, 22, 'seguridad', NULL),
(13, 22, 'Agente', NULL),
(14, 22, 'patrimoniallll', NULL);
...
(1, 'admin', 'root', 'root@gmail.com', '71574122', '965208467', '$2y$10$zIZRLiAGHVLHbDMFDdafxO.F6ZPFzORE0OS68hjYFEfzVE3i0.7sm', 'Administrador', '30052023083637IMG_20220815_131834.jpg', '2023-05-02 00:46:19'),
(8, 'Ysabel Yamunaque Santoyo', 'user', 'isabel@gmail.com', '17591502', '', '$2y$10$CbHWzgIYMTJErC9hprTjn.XHz5N7/kIm91ZxQ3z8C939oCf8Rjxae', 'Usuario', '01062023121235323001519_3362523854021398_545672291732002656_n.png', '2023-05-31 17:12:35'),
(9, 'Aaron Gonzales Bellido', 'prueba', 'isabel@gmail.com', '74610577', '', '$2y$10$XRMmM4aZQQ82TgQPQdNutu5u5eDzeWO6UllGq6FPd3s.Udb5kHpMi', 'Usuario', '01062023030046323001519_3362523854021398_545672291732002656_n.png', '2023-06-01 15:00:46');
...
--
ALTER TABLE `tblkeywords`
  MODIFY `cod_keyword` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tblpuestos`
  MODIFY `cod_puesto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
