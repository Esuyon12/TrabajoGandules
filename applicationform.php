<section id="content">
    <div class="container content">
        ...
        ?>
            <div class="col-sm-12">
                <div class="row">
                    <h2 class=" ">DETALLLES DEL TRABAJO</h2>
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="row contentbody">
                                <div class="col-sm-6">
                                    <ul>
                                        <li><i class="fp-ht-bed"></i>Numero de personal requerido: <?php echo $result->REQ_NO_EMPLOYEES; ?></li>
                                        <li><i class="fp-ht-food"></i>Sueldo : <?php echo number_format($result->SALARIES, 2);  ?></li>
                                        <li><i class="fa fa-sun-"></i>Duración de contrato : <?php echo $result->DURATION_EMPLOYEMENT; ?></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul>
                                        <li><i class="fp-ht-tv"></i>Preferencia de genero : <?php echo $result->PREFEREDSEX; ?></li>
                                        <li><i class="fp-ht-computer"></i>Lugar de trabajo : <?php echo $result->SECTOR_VACANCY; ?></li>
                                    </ul>
                                </div>
                                <div class="col-sm-12">
                                    <p>Cualidades/Experiencias :</p>
                                    <ul style="list-style: none;">
                                        <li><?php echo $result->QUALIFICATION_WORKEXPERIENCE; ?></li>
                                    </ul>
                                </div>
                                <div class="col-sm-12">
                                    <p>Descripción de trabajo:</p>
                                    <ul style="list-style: none;">
                                        <li><?php echo $result->JOBDESCRIPTION; ?></li>
                                    </ul>
                                </div>
                                <div class="col-sm-12">
                                    <p>Sede empleador : <?php echo  $result->COMPANYNAME; ?></p>
                                    <p>Dirección : <?php echo  $result->COMPANYADDRESS; ?></p>
                                </div>
                            </div>
                        </div>
        ...
        <?php } else { ?>
            <form class="form-horizontal span6  wow fadeInDown" action="process.php?action=submitapplication&JOBID=<?php echo $result->JOBID; ?>" enctype="multipart/form-data" method="POST">
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <h2 class=" ">DETALLES DE TRABAJO</h2>
                        <div class="panel">
                            <div class="panel-header">
                                <div style="border-bottom: 1px solid #ddd;padding: 10px;font-size: 25px;font-weight: bold;color: #000;margin-bottom: 5px;"><a href="<?php echo web_root . 'index.php?q=viewjob&search=' . $result->JOBID; ?>"><?php echo $result->OCCUPATIONTITLE; ?></a>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="row contentbody">
                                    <div class="col-sm-6">
                                        <ul>
                                            <li><i class="fp-ht-bed"></i>Numero de trabajadores requeridos : <?php echo $result->REQ_NO_EMPLOYEES; ?></li>
                                            <li><i class="fp-ht-food"></i>Sueldo : <?php echo number_format($result->SALARIES, 2);  ?></li>
                                            <li><i class="fa fa-sun-"></i>Duración de empleo : <?php echo $result->DURATION_EMPLOYEMENT; ?></li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-6">
                                        <ul>
                                    ...
                                    <div class="col-sm-12">
                                        <p>Cualidades/Experiencias laborales :</p>
                                        <ul style="list-style: none;">
                                            <li><?php echo $result->QUALIFICATION_WORKEXPERIENCE; ?></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <p>Sede contratante : <?php echo  $result->COMPANYNAME; ?></p>
                                        <p>Dirección : <?php echo  $result->COMPANYADDRESS; ?></p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <label class="col-md-2" for="picture" style="padding: 0;margin: 0;">Adjunte su currículum aquí:</label>
                                <div class="col-md-10" style="padding: 0;margin: 0;">
                                    <input id="picture" name="picture" type="file">
                                    <input name="MAX_FILE_SIZE" type="hidden" value="1000000">
                                </div>
